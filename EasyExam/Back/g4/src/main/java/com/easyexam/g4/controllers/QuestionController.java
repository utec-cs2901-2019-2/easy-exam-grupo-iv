...
public class QuestionController {
    ...
    @PutMapping("/api/questionPUT") public  void ChangeQuestion(@RequestBody QuestionPOSTRequest questionRequest , Long questionID){

        Question myQuestion = questionRepository.findById(questionID).get();

        myQuestion.setAllowed(questionRequest.allowed);
